...
(function() {
  var NUM_BARS, Pingr, bars, changeNumBars, clearChildren, currNumBars, disconnectFnctn, disconnected, elem, hideBars, initElement, num_requests, pingServer, reconnectFnctn, rootDomain, updatePing;
  ...
  disconnectFnctn = void 0;

  reconnectFnctn = void 0;
  ...
  Pingr.init = function(width, height) {
    ...
    pingCallback = function(pingTime) {
      ...
      updatePing(pingTime);
      if (pingTime === -1) {
        return setTimeout(pingServer, 1000, pingCallback);
      } else {
        return setTimeout(pingServer, 100, pingCallback);
      }
    };
