...
(function() {
  var NUM_BARS, Pingr, bars, changeNumBars, currNumBars, elem, hideBars, initElement, num_requests, pingServer, rootDomain, updatePing;
  ...
  initElement = function(width, height) {
    ...
    margin = 2;
    barWidth = (width - (NUM_BARS * margin)) / 4;
    barHeightIncrement = (height - (NUM_BARS * margin)) / 4;
    results = [];
    for (i = j = 1, ref = NUM_BARS; j <= ref; i = j += 1) {
